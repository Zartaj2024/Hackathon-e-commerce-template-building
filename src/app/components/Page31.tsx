...
const Page31 = () => {
    return (
        <div className="h-screen bg-no-repeat bg-center bg-cover" style={{backgroundImage: "url('/background.jpg')"}}>
        ...
        <section className="grid text-black font-bold text-2xl justify-left items-left py-[170px] px-[170px] space-y-9">
          ...
          <div>
            <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-8 rounded-md">Get Quote Now</button>
          </div>
        </section>
